...
const STAGES: Stage[] = [
  { n: "01", title: "Caller hits /verify, unpaid", detail: "No PAYMENT-SIGNATURE header → HTTP 402 challenge returned via the official OKX Payment SDK." },
  { n: "02", title: "Buyer signs, OKX facilitator settles", detail: "Buyer signs an EIP-3009 transferWithAuthorization offline — no gas, no pre-approval. OKX's own facilitator service verifies and settles it on-chain after the response is ready." },
  ...
  { n: "09", title: "Response", detail: "Signed verdict JSON returned alongside a PAYMENT-RESPONSE header proving the settlement transaction that paid for it." },
